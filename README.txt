...
A simple directory monitor geared towards POSIX-based
systems. It can act as either a server or client. In server
mode, one specifies a directory monitor to and a refresh
period. It sends updates to any connected client.
